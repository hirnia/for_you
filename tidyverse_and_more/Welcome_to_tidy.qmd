...
![Me (Megan Hirni)](D/Other/Career/10.jpg){fig-alt="A portrait photo of me (Megan Hirni)." width="130"}
...
Tidyverse is a set of packages that follows a similar coding style and output throughout. (<https://www.tidyverse.org>). Several packages—including `ggplot2`, `dplyr`, and `purrr` are housed under `tidyverse`, so installing `tidyverse` provides access to all housed core `tidyverse` packages.
...
The `airquality` dataset is a built-in `R` dataset that containing daily air quality measurements in New York City May to September 1973 (Chambers et al., 1983) with variables:
...
![ggplot2 logo](logo.png){fig-align="left" width="99"}
...
![](images/clipboard-2959541466.png){width="99"}
